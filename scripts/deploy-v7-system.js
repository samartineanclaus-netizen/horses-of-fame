...
async function main(){const [owner]=await ethers.getSigners();const deployed=await deploySystem(systemConfig(process.env),owner);console.log(JSON.stringify(deployed.result,null,2));}
